    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(crtm.soap.MultimodalInformation_Service.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = crtm.soap.MultimodalInformation_Service.class.getResource(".");
            url = new URL(baseUrl, "http://www.citram.es:8080/WSMultimodalInformation/MultimodalInformation.svc?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://www.citram.es:8080/WSMultimodalInformation/MultimodalInformation.svc?wsdl', retrying as a local file");
    ...
    public MultimodalInformation_Service() {
        super(MULTIMODALINFORMATION_WSDL_LOCATION, new QName("http://tempuri.org/", "MultimodalInformation"));
    }
